...
# Script for making the confound file related to scrubbed movement.
# Goal of this script:  Supply "mask" regressors for each
# TR with a frame displacement larger than 0.9.
...
# After running this script you will want to add the output files to
# FEAT in the following manner (all can be found in scrub_files directory):
...
# Created 5/29/2014 by Jeanette Mumford, altered by Laura Engelhardt January 2016.

if [ "$1" == "-h" ]
then
  echo "Usage: make_confound_twins.sh <bold file name> <fd thresh>"
fi
