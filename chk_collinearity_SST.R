...
# create one large df
  ...
  write.csv(x=all.subs, file='SST_all_desmat.csv')
  vif.subs = all.subs[(all.subs$value > 10 & is.na(all.subs$value)==FALSE),]
  write.csv(x=vif.subs, file='SST_VIFgreaterthan10.csv')
